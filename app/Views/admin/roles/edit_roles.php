...
<div class="p-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
    <div>
        <h1 class="text-2xl font-bold text-slate-900 dark:text-slate-100 leading-tight tracking-tight">Edit Role</h1>
        <p class="text-slate-500 dark:text-slate-400 text-sm mt-1">Update an existing role.</p>
    </div>
...
<form action="<?= base_url('admin/roles/update/' . $role['id']) ?>" method="post" enctype="multipart/form-data" class="p-8 space-y-6">
