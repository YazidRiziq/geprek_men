...
<div class="p-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
    <div>
        <h1 class="text-2xl font-bold text-slate-900 dark:text-slate-100 leading-tight tracking-tight">Add New Employee</h1>
        <p class="text-slate-500 dark:text-slate-400 text-sm mt-1">Create a new employee for your restaurant.</p>
    </div>
...
<!-- Form Section -->
<form action="<?= base_url('/admin/employees/store') ?>" method="post" enctype="multipart/form-data" class="p-8 space-y-6">
    ...
    <div class="flex flex-col gap-2">
        ...
        <div class="relative">
            <input value="<?= old('fullname') ?>" id="fullname" name="fullname" class="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all text-slate-900 dark:text-slate-100 placeholder:text-slate-400" placeholder="e.g. John Doe" type="text" required/>
        </div>
    </div>
